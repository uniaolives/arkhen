...
class EntropyGate:
    ...
    def measure_chaos(self, signal) -> float:
        ...
        base_entropy = getattr(signal, 'entropy_score', getattr(signal, 'entropy', 0.5))
...
class ThePrism:
    ...
    async def refract(self, signal) -> Dict:
        """Alias for refract_request to match final integration scripts"""
        return await self.refract_request(signal)
